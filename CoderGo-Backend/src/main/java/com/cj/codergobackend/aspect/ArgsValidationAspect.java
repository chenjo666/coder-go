package com.cj.codergobackend.aspect;
...
public class ArgsValidationAspect {
    ...
    @Around("execution(* com.cj.codergobackend.controller.*.*(..))  " +
            "&& !execution(* com.cj.codergobackend.controller.ArticleController.searchArticlesByMysql(..))" +
            "&& !execution(* com.cj.codergobackend.controller.ArticleController.searchArticlesByElasticsearch(..))")
